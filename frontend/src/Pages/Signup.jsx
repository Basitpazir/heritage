    ...
    <div className={`min-h-screen bg-black flex items-center justify-center px-6 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[9px] text-white/30 uppercase tracking-[0.4em]">Join the Inner Circle</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-[9px] uppercase tracking-[0.3em] text-white/30 mb-3">Full Name</label>
        ...
        <div className="mt-10 text-center">
          <p className="text-[9px] text-white/20 uppercase tracking-widest">
            Already a member?{' '}
            <Link to="/login" className="text-white/50 hover:text-white transition-colors ml-1">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
